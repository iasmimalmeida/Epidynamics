---
title: "Análise Regressão Logística Binomial A2 - 2017-2022"
format: html
editor: visual
editor_options: 
...
3.  Teste de Hosmer-Lemeshow : Avalia se as probabilidades previstas pelo modelo são bem ajustadas aos dados observados. Interpretação: p-valor \> 0.05 → Indica bom ajuste p-valor \< 0.05 → Indica que o modelo pode não estar ajustando bem.

4.  Curva ROC e AUC (Área Sob a Curva) : Mede a capacidade do modelo de discriminar entre as classes (0 e 1).
...
5.  Matriz de Confusão e Acurácia : Avalia o desempenho do modelo na predição correta das classes.
